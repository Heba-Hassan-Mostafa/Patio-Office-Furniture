        ...
        function (e, r) {
          function f(e) {
              ...
              for (var t = [], a = -y; f + y > a; a += e.cell_size)
                for (var o = -v; n + v > o; o += e.cell_size) {
                  var c = a + e.cell_size / 2 + r(rand(), [0, 1], [-w, w]),
                    u = o + e.cell_size / 2 + r(rand(), [0, 1], [-w, w]);
                  t.push([c, u].map(Math.floor));
                }
              return t;
            }
            function o(e) {
            ...
            if (
              ((e = i(u, e)),
              (rand = t(e.seed)),
              "random" === e.x_colors && (e.x_colors = l()),
              "random" === e.y_colors && (e.y_colors = l()),
            ...
            if (e.color_function)
              ...
              d = function (r, f) {
                return a.interpolate(s(r), b(f), 0.5, e.color_space);
              };
            }
            for (
              var h = e.width,
                g = e.height,
                p = Math.floor((h + 4 * e.cell_size) / e.cell_size),
                m = Math.floor((g + 4 * e.cell_size) / e.cell_size),
                y = (p * e.cell_size - h) / 2,
                v = (m * e.cell_size - g) / 2,
        ...
        function (e, r) {
          function f(e, r) {
            function f() {
              ...
              return (
                f.setAttribute("width", r.width),
                f.setAttribute("height", r.height),
                e.forEach(function (e) {
                  var t = n.createElementNS(
                    "http://www.w3.org/2000/svg",
                    "path"
                  );
                  t.setAttribute("d", "M" + e[1].join("L") + "Z"),
                    t.setAttribute("fill", e[0]),
                    t.setAttribute("stroke", e[0]),
                    t.setAttribute("stroke-width", r.stroke_width),
                    f.appendChild(t);
                }),
                f
              );
            ...
            function t(f) {
              return (
                f || (f = n.createElement("canvas")),
                f.setAttribute("width", r.width),
                f.setAttribute("height", r.height),
                (ctx = f.getContext("2d")),
                (ctx.canvas.width = r.width),
                (ctx.canvas.height = r.height),
                e.forEach(function (e) {
          ...
          (function () {
            ...
            (s = function (e, f, n, t) {
              ...
              "function" == typeof e && e.amd
                ...
                : ((O = "undefined" != typeof n && null !== n ? n : this),
                  (O.chroma = s)),
              (s.color = function (e, f, n, t) {
                return new r(e, f, n, t);
              }),
              ...
              (s.interpolate = function (e, f, n, t) {
                return null == e || null == f
                  ? "#000"
                  : ("string" === U(e) && (e = new r(e)),
                    "string" === U(f) && (f = new r(f)),
                    e.interpolate(n, f, t));
              }),
              (s.mix = s.interpolate),
              (s.contrast = function (e, f) {
                var n, t;
                return (
                  "string" === U(e) && (e = new r(e)),
                  "string" === U(f) && (f = new r(f)),
                  (n = e.luminance()),
                  (t = f.luminance()),
                  n > t ? (n + 0.05) / (t + 0.05) : (t + 0.05) / (n + 0.05)
                );
              }),
              ...
              (r = (function () {
                function e() {
                  ...
                  for (
                    t = this, f = [], l = 0, i = arguments.length;
                    i > l;
                    l++
                  )
                  ...
                  if (0 === f.length)
                    ...
                    "string" === U(f[0])
                      ...
                      ? ((p = f[0]._rgb),
                        ...
                        (e = p[3]),
                        (n = "rgb"))
                      : f.length >= 3 && ((o = f[0]), (c = f[1]), (u = f[2]));
                  3 === f.length
                    ? ((n = "rgb"), (e = 1))
                    : 4 === f.length
                    ? "string" === U(f[3])
                      ? ((n = f[3]), (e = 1))
                      : "number" === U(f[3]) && ((n = "rgb"), (e = f[3]))
                    : 5 === f.length && ((e = f[3]), (n = f[4])),
                    null == e && (e = 1),
                    "rgb" === n
                      ? (t._rgb = [o, c, u, e])
                      : "gl" === n
                      ? (t._rgb = [255 * o, 255 * c, 255 * u, e])
                      : "hsl" === n
                      ? ((t._rgb = v(o, c, u)), (t._rgb[3] = e))
                      : "hsv" === n
                      ? ((t._rgb = w(o, c, u)), (t._rgb[3] = e))
                      : "hex" === n
                      ? (t._rgb = m(o))
                      : "lab" === n
                      ? ((t._rgb = k(o, c, u)), (t._rgb[3] = e))
                      : "lch" === n
                      ? ((t._rgb = j(o, c, u)), (t._rgb[3] = e))
                      : "hsi" === n && ((t._rgb = y(o, c, u)), (t._rgb[3] = e)),
                    (a = b(t._rgb));
                }
                return (
                  ...
                  (e.prototype.luminance = function (r, f) {
                    ...
                    return (
                      null == f && (f = "rgb"),
                      arguments.length
                        ? (0 === r && (this._rgb = [0, 0, 0, this._rgb[3]]),
                          1 === r &&
                  ...
                  (e.prototype.css = function (e) {
                    ...
                    return (
                      ...
                      (f = this),
                      (n = f._rgb),
                      3 === e.length && n[3] < 1 && (e += "a"),
                      "rgb" === e
                        ? e +
                          "(" +
                          n.slice(0, 3).map(Math.round).join(",") +
                          ")"
                        : "rgba" === e
                        ? e +
                          "(" +
                  ...
                  (e.prototype.interpolate = function (r, f, n) {
                    ...
                    if (
                      ((d = this),
                      null == n && (n = "rgb"),
                      "string" === U(f) && (f = new e(f)),
                      "hsl" === n || "hsv" === n || "lch" === n || "hsi" === n)
                    )
                      "hsl" === n
                        ? ((p = d.hsl()), (m = f.hsl()))
                        : "hsv" === n
              ...
              (b = function (e) {
                ...
                for (r in e)
                  3 > r
                    ? (e[r] < 0 && (e[r] = 0), e[r] > 255 && (e[r] = 255))
                    : 3 === r &&
                      (e[r] < 0 && (e[r] = 0), e[r] > 1 && (e[r] = 1));
                return e;
              }),
              (p = function (e) {
                var r, f, n, t, a, o, c, u;
                if (((e = e.toLowerCase()), null != s.colors && s.colors[e]))
                  return m(s.colors[e]);
                if (
                  (n = e.match(
                    /rgb\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*\)/
                  ...
                  for (t = n.slice(1, 5), f = o = 0; 3 >= o; f = ++o)
                    t[f] = +t[f];
                else if (
                  (n = e.match(
              ...
              (y = function (e, r, f) {
                ...
                return (
                  ...
                  1 / 3 > e
                    ? ((n = (1 - r) / 3),
                      (c = (1 + (r * g(o * e)) / g(a - o * e)) / 3),
                      (t = 1 - (n + c)))
                    : 2 / 3 > e
                    ? ((e -= 1 / 3),
                      (c = (1 - r) / 3),
                      (t = (1 + (r * g(o * e)) / g(a - o * e)) / 3),
                      (n = 1 - (c + t)))
                    : ((e -= 2 / 3),
                      (t = (1 - r) / 3),
                      (n = (1 + (r * g(o * e)) / g(a - o * e)) / 3),
                      (c = 1 - (t + n))),
                  (c = N(f * c * 3)),
                  (t = N(f * t * 3)),
                  (n = N(f * n * 3)),
              ...
              (w = function () {
                ...
                if (
                  ...
                  switch (
                    ...
                    case 0:
                      (s = [i, l, a]), (c = s[0]), (f = s[1]), (e = s[2]);
                      break;
                    case 1:
                      (b = [o, i, a]), (c = b[0]), (f = b[1]), (e = b[2]);
                      break;
                    case 2:
                      (h = [a, i, l]), (c = h[0]), (f = h[1]), (e = h[2]);
                      break;
                    case 3:
                      (g = [a, o, i]), (c = g[0]), (f = g[1]), (e = g[2]);
                      break;
                    case 4:
                      (p = [l, a, i]), (c = p[0]), (f = p[1]), (e = p[2]);
                      break;
                    case 5:
                      (m = [i, a, o]), (c = m[0]), (f = m[1]), (e = m[2]);
                  }
                return (
                  (c = Math.round(c)),
                  (f = Math.round(f)),
              ...
              (k = function (e, r, f) {
                ...
                return (
                  void 0 !== e &&
                    3 === e.length &&
                    ((d = e), (e = d[0]), (r = d[1]), (f = d[2])),
                  void 0 !== e &&
                    3 === e.length &&
                    ((s = e), (e = s[0]), (r = s[1]), (f = s[2])),
                  (o = (e + 16) / 116),
                  (a = o + r / 500),
                  (i = o - f / 200),
                  (a = x(a) * c),
                  (o = x(o) * u),
                  (i = x(i) * l),
                  (t = T(3.2404542 * a - 1.5371385 * o - 0.4985314 * i)),
                  (n = T(-0.969266 * a + 1.8760108 * o + 0.041556 * i)),
                  (f = T(0.0556434 * a - 0.2040259 * o + 1.0572252 * i)),
                  [N(t, 0, 255), N(n, 0, 255), N(f, 0, 255), 1]
                );
              }),
              (x = function (e) {
              ...
              (E = function () {
                ...
                return (
                  ...
                  (r = S(r)),
                  (e = S(e)),
                  (n = Y((0.4124564 * f + 0.3575761 * r + 0.1804375 * e) / c)),
                  (t = Y((0.2126729 * f + 0.7151522 * r + 0.072175 * e) / u)),
                  (a = Y((0.0193339 * f + 0.119192 * r + 0.9503041 * e) / l)),
                  [116 * t - 16, 500 * (n - t), 200 * (t - a)]
                );
              }),
              (S = function (e) {
                ...
                return (
                  ...
                  (c = function (e, r) {
                    ...
                    if (
                      ...
                      null != e &&
                        "string" === U(e) &&
                        null != (null != (c = s.brewer) ? c[e] : void 0) &&
                        (e = s.brewer[e]),
                      "array" === U(e))
                    ) {
                      for (
                        e = e.slice(0), f = t = 0, u = e.length - 1;
                        u >= 0 ? u >= t : t >= u;
                        f = u >= 0 ? ++t : --t
                      )
                  ...
                  (f = function (e) {
                    ...
                    return (
                      ...
                      h.length > 2 &&
                        ((a = h.length - 1),
                        (r = t(e)),
                        (n = h[0] + (h[1] - h[0]) * (0 + 0.5 * x)),
                        (f = h[a - 1] + (h[a] - h[a - 1]) * (1 - 0.5 * x)),
                        (o =
                          m +
                          ((h[r] + 0.5 * (h[r + 1] - h[r]) - n) / (f - n)) *
                            (p - m))),
                      o
                    );
                  }),
                  ...
                  (n.domain = function (e, r, f, t) {
                    ...
                    return (
                      ...
                      arguments.length
                        ? (null != r &&
                            ((a = s.analyze(e, t)),
                            (e = 0 === r ? [a.min, a.max] : s.limits(a, f, r))),
                          u(e),
                          n)
                        : h
                    );
              ...
              (s.analyze = function (e, r, f) {
                ...
                if (
                  ...
                  for (u = 0, l = e.length; l > u; u++) (o = e[u]), c(o);
              ...
              (s.limits = function (e, r, f) {
                ...
                if (
                  (null == r && (r = "equal"),
                  null == f && (f = 7),
                  "array" === U(e) && (e = s.analyze(e)),
                  (p = e.min),
                  (h = e.max),
                  (N = e.sum),
                  (A = e.values.sort(function (e, r) {
                    return e - r;
                  })),
                  (b = []),
                  "c" === r.substr(0, 1) && (b.push(p), b.push(h)),
                  "e" === r.substr(0, 1))
                ) {
                  for (
                    b.push(p), l = G = 1, C = f - 1;
                    C >= 1 ? C >= G : G >= C;
                    l = C >= 1 ? ++G : --G
                  )
                    b.push(p + (l / f) * (h - p));
                  ...
                  for (a.push(h); j; ) {
                    ...
                    for (
                      ...
                      for (
                        q = A[l], y = Number.MAX_VALUE, i = O = 0, Q = f - 1;
                        Q >= 0 ? Q >= O : O >= Q;
                        i = Q >= 0 ? ++O : --O
                      )
              ...
              (U = (function () {
                ...
                return function (r) {
                  var f;
                  return (
                    (f = Object.prototype.toString.call(r)), e[f] || "object"
                  );
                };
              })()),
              (N = function (e, r, f) {
              ...
              return (
                a > _
                  ...
                  : ((c = -((m - g) / (y - p))),
                    ...
                    (s = (y + w) / 2),
                    (t = (c * l - u * i + s - d) / (c - u)),
                    (o = _ > k ? c * (t - l) + d : u * (t - i) + s)),
                (b = m - t),
                (h = y - o),
                { i: r, j: f, k: n, x: t, y: o, r: b * b + h * h }
              );
            }
            function t(e) {
              var r, f, n, t, a, o;
              ...
              triangulate: function (r, f) {
                ...
                for (i.length = 0, o = d.length; o--; )
                  d[o].i < y &&
                    d[o].j < y &&
                    d[o].k < y &&
                    i.push(d[o].i, d[o].j, d[o].k);
                return i;
              },
              contains: function (e, r) {
                if (
                  (r[0] < e[0][0] && r[0] < e[1][0] && r[0] < e[2][0]) ||
                  (r[0] > e[0][0] && r[0] > e[1][0] && r[0] > e[2][0]) ||
                  (r[1] < e[0][1] && r[1] < e[1][1] && r[1] < e[2][1]) ||
                  (r[1] > e[0][1] && r[1] > e[1][1] && r[1] > e[2][1])
                )
                  return null;
                var f = e[1][0] - e[0][0],
                  ...
                  o = f * a - n * t;
                if (0 === o) return null;
                var c = (a * (r[0] - e[0][0]) - n * (r[1] - e[0][1])) / o,
                  u = (f * (r[1] - e[0][1]) - t * (r[0] - e[0][0])) / o;
                return 0 > c || 0 > u || c + u > 1 ? null : [c, u];
              },
            }),
          ...
          !(function (e, f, n, t, a, o, c, u, l) {
            ...
            function h(r) {
              try {
                return p
                  ? g(p.randomBytes(t))
                  : (e.crypto.getRandomValues((r = new Uint8Array(t))), g(r));
              } catch (n) {
                return [
                  +new Date(),
                  e,
            ...
            var p,
              ...
              _ = (n["seed" + l] = function (e, r, o) {
                var c = [];
                r = 1 == r ? { entropy: !0 } : r || {};
                var u = b(s(r.entropy ? [e, g(f)] : null == e ? h() : e, 3), c),
                  p = new i(c);
                return (
                  b(g(p.S), f),
                  (
