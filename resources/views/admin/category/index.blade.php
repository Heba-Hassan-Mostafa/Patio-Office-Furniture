          ...
          <table id="datatable1" class="table display responsive nowrap">
            ...
            <tbody id="tablecontents">
                ...
                <tr class="row1" data-id={{ $cat->id }}>
                    ...
                    <td>
                        <a href="{{ url(route('category.edit', $cat->id)) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                        {!! Form::open(['route'=>['category.destroy',$cat->id],'method'=>'delete','style'=>'display:inline-block']) !!}
