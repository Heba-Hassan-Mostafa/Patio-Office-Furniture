        ...
        <div class="table-wrapper">
          <table id="datatable1" class="table display responsive nowrap">
            ...
            @endif
                    ...
                    <td>
                        <a href="{{ url(route('post-category.edit', $cat->id)) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                        {!! Form::open(['route'=>['post-category.destroy',$cat->id],'method'=>'delete','style'=>'display:inline-block']) !!}
...
@include('admin.post-category.model')
