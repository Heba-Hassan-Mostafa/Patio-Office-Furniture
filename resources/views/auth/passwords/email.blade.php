...
@section('content')
<div class="container">
    <div class="row justify-content-center" style="margin: 35px auto;">
        <div class="col-md-8">
            <div class="card">
                <div class="change-title-pass">Reset Password</div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-success out-style d-block"
                                >
                                    Send
                                </button>
                            </div>
