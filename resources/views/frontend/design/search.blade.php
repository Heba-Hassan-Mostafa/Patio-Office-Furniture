...
<div class="head-product-page">
    <div class="overlay">
      <h1 class="title-sub-pages"> Search Products</h1>
   ...
   <div class="products-category-content">
    ...
    @php
        $categories = App\Models\Category::whereHas('products')->whereStatus(1)->orderBy('order','asc')->get();
    ...
    <div class="row product-page-item">
      ...
      @endforeach
      @else
      <div class="text-center">This Product Not Found</div>
      @endif
        </div>

  </div>
  <div class="pagi-style">{!! $products->appends(request()->all())->links() !!}</div>
